...
class Viewrequest extends Component {
    ...
    componentDidMount = async () => {
        ...
        firebase.firestore().collection('Essentials').doc(this.props.route.params.data).onSnapshot(doc => {
            console.log(doc.data())
            this.setState({ data: doc.data(), loading: false, products: doc.data().products, status: doc.data().status })
        }).catch(err => {
            alert(err.message)
        })
    }
