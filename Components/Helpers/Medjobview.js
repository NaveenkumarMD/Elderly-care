...
class Medjobview extends Component {
    constructor(props) {
        super(props)
        this.state = {
            products: [],
            ...
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10 }}>
                        <Text style={{ color: 'white' }}>12/09/2002</Text>
                        <Text style={{ color: 'white' }}>12.90</Text>
                    </View>
