...
class Traveljobview extends Component {
    constructor(props) {
        super(props)
        this.state = {
            data:{},
            ...
            <View style={styles.container}>
                <ScrollView>
                    ...
                    <View style={{borderBottomColor: '#424242', borderBottomWidth: 2}}>
                        <Text style={{ color: 'white', fontSize: 24, padding: 10, fontWeight: 'bold' }}>Travel details</Text>
                        <View style={{paddingLeft:20}}>
                        <Text style={{color:'white', fontSize: 22, padding: 10}}>Location:{this.state.data.location}</Text>
                        <Text style={{color:'white', fontSize: 22, padding: 10}}>Mode:{this.state.data.mode}</Text>
                        <Text style={{color:'white', fontSize: 22, padding: 10}}>Purpose:{this.state.data.purpose}</Text>
                        <Text style={{color:'white', fontSize: 22, padding: 10}}>Date:{this.state.data.traveldate}</Text>
                        <Text style={{color:'white', fontSize: 22, padding: 10}}>Time:{this.state.data.traveltime}</Text>
                        </View>
                    </View>
